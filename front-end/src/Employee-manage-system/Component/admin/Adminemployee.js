...
const Adminemployee = ({ setOption }) => {
                ...
                cashier: {
                    short:
                        reject?.cashier?.short +
                            (reject?.cashier?.TotalSales -
                                reject?.cashier?.cashInhand) || 0,
    ...
    const handleremove = async () => {
        try {
            const res = await axios.post(
                "http://localhost:4000/employee/position",
                reject
            );
            if (res.data) {
                await empfetch();
    ...
    return (
        <div className="col-12 main-adminemp text-dark">
                        ...
                        <div class="carousel-inner">
                            {EmpDetails.map(
                                ...
                                <div class="carousel-item active">
                                    <h1 className="text-center text-bold text-danger">
                                        No Data
                                    </h1>
                                </div>
                            ) : (
                        ...
                        <div class="modal-body text-dark">
                            ...
                            <div style={{ minHeight: `100%` }}>
                                ...
                                >
                                    ...
                                    >
                                        <p>
                                            Do you want to clear Short for{" "}
                                            {reject.name}
                                        </p>
